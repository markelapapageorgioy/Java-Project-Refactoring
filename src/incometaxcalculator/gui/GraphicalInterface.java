  ...
  public GraphicalInterface() {
    ...
    btnLoadTaxpayer.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
       ...
       // fileChooser.setCurrentDirectory(new File(System.getProperty("Users.User.Documents.files"))); ////////////////////
        //File selectedFile = fileChooser.getCurrentDirectory();
 
        final File folder = new File("C:\\Users\\User\\Documents\\files");    //added
        
        
        try {
          for (String f: allFiles(folder)) {
            taxpayerManager.loadTaxpayer(f);
          }
        ...
        for(int n: taxpayerManager.getTaxpayerHashmap().keySet() ) {
          ...
          System.out.println(taxpayerManager.getTaxpayerHashmap().keySet());
          taxRegisterNumberModel.addElement(str1);                                 //added
        }
          ...
          if (answer == 0) {
            ...
            try {
              ...
              if (taxpayerManager.containsTaxpayer(trn)) {
                ...
                //taxRegisterNumberModel.addElement("bannana");
              }
